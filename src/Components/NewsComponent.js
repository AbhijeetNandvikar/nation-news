...
export class NewsComponent extends Component {
    constructor(props) {
        super(props)
        this.newsList = '';
        fetch(`https://newsapi.org/v2/top-headlines?country=in&apiKey=19a9d8aad2e545d6bda9389a7a793af1`)
            .then(response => {
    ...
    searchNews = (query) => {
        fetch(`https://newsapi.org/v2/everything?q=${query}&sortBy=popularity&apiKey=19a9d8aad2e545d6bda9389a7a793af1`)
    ...
    searcHeadlines = (query) => {
        fetch(`https://newsapi.org/v2/everything?q=${query + ` india`}&apiKey=19a9d8aad2e545d6bda9389a7a793af1`)
            .then(response => response.json())
            .then(res => {
                this.newsList = res.articles.slice()
                this.news = this.renderNews(this.newsList)
